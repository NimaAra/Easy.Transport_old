namespace EasyTransport.Common.Extensions
{
    ...
    public static class UriExtensions
    {
        ...
        internal static Uri AddParametersToQueryString(this Uri uri, string parameter, string value)
        {
            Ensure.NotNull(uri, nameof(uri));
        ...
        /// <param name="value"></param>
        /// <returns>New Uri with the Query String</returns>
        internal static Uri AddParametersToQueryString(this Uri uri, string parameter, int value)
        {
        ...
        /// <param name="value"></param>
        /// <returns>New Uri with the Query String</returns>
        internal static Uri AddParametersToQueryString(this Uri uri, string parameter, long value)
        {
        ...
        internal static string WithModifiedQuerystring(this Uri uri, Action<IEnumerable<KeyValuePair<string, string>>> modification)
        {
            Ensure.NotNull(uri, nameof(uri));
